  ...
  return (
    <div className='my-auto'>
        <form method="post" onSubmit={handleSubmit} className='shadow-black border rounded p-[30px] border-[#f2f4f9] min-w-[350px] bg-[#fff]'>
            <h1 className='block text-center text-[22px] font-semibold mb-[15px] mt-[-5px] text-[#18214d]'>Sign In</h1>
                ...
                <div className='w-1/2 py-[12px]'>
                    <div className='min-h-[1.5rem] pl-[1.5rem] mb-[.125rem]'>
                        <input
                            ...
                            id='form-checkbox'
                        />
                        <label className='text-[#18214d]' htmlFor="form-checkbox">Remember me</label>
                    </div>
                </div>
                <div className='w-1/2 py-[12px]'>
                    <div className='text-right'>
                        <Link className='text-[#0d6efd]' to={'/recover'}>Forgot Password?</Link>
                    </div>
                </div>
            </div>
