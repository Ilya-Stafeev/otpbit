        ...
        <div className="px-[15px] mx-auto max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1200px]">
            <div className='my-[30px]'>
                <div>
                    ...
                    <br />
                    The contract is concluded between the Internet service for the exchange of title units, hereinafter referred to as the Contractor, on the one hand, and the Customer, represented by the one who used the services of the Contractor, on the other hand. Otpbit represents the voice of the blockchain and digital asset industry in Greece. Registered in Greece under number 122000301000.4. Licensed by Greece financial regulator HCMC for the provision of online crypto exchange under License number 4/792/20.07.2017. 
                </div>
                <div>2. List of terms. </div>
                <div>2.1. Title unit exchange is an automated Internet service product provided by the Contractor on the basis of these rules.</div>
                <div>2.2. Customer - an individual who agrees with the terms of the Contractor and this agreement, to which he joins.</div>
                <div>2.3. The title character is a conventional unit of a particular payment system, which corresponds to the calculations of electronic systems and indicates the scope of rights corresponding to the agreement between the electronic payment system and its Customer.</div>
                <div>2.4. Application - information transmitted by the Customer for the use of the Contractor's funds in electronic form and indicating that he accepts the terms of use of the service, which are offered by the Contractor in this application.</div>
                <div>2.5. KYC & AML - "Know Your Customer" (know your customer) and "Anti-Money Laundering" (anti-money laundering).</div>
                <div>2.6. Rate — the cost ratio of cryptocurrency, electronic money and fiat currency to each other during the exchange.</div>
                <div>
                ...
                <div>
                    5.15. The Service has the right to refuse to provide services to the User if the User does not provide complete and sufficient data necessary for his identification, and block the Funds received from the User until such data is provided by him.
                </div>
                <div>
                    5.16. To check transactions against money laundering, the exchange office uses the AMLbot service. You can learn more about this service at the link: amlbot.com
                </div>
                <div>
                    5.17. When checking transactions for anti-money laundering, the exchange office focuses on high-risk parameters. The high risk parameters are : "Dark Service" ; "Dark Market" ; "Exchange Fraudulent" ; "scam" ; "Illegal Service" ; "Stolen" ; "Mixer" ; "Ransom" ; "Gambling".
                </div>
                <div>
                    5.17.1. In order to counter the legalization of proceeds from crime and the financing of terrorism, exchange offices conduct AML checks on transactions received from clients. If the transaction is identified.
                </div>
                <div>
                    5.17.2. In case of blocking the cryptocurrency by the exchange. The transaction will be suspended until the full release of funds, i.e. before the removal of all restrictions by the regulator.
                </div>
                <div>
                    6. Warranty Period
                </div>
                <div>
                    6.1 Reputational and material guarantees are borne by the licensee loptrade.com
                </div>
                <div>
                ...
                <div>
                    7.2 The user has 3 withdrawals before requesting verification, the withdrawal must not exceed 60,000 USD
                </div>
                <div>
                    7.3 Under no circumstances may a person under 18 years of age be registered or used.
                </div>
                <div>
                    7.4 If you are transferring to a country with a high risk for financial transactions or have a multi-account and created a new identity to circumvent this clause, any country to which the United States has embargoed goods or services; from a high-risk of illegal financial transaction country, to withdraw funds from these countries, the user needs to go through an insurance payment check . This insurance payment will be refunded after 12 hours using your account, if you have no complaints. Your account may be frozen until a fee of up to 75% is paid, in case of refusal or conflict - blocked. Countries with high financial risk are those that are under sanctions at the time of the transaction, take part in or support a war, finance or are associated with the financing of terrorism, help to circumvent sanctions to other countries, are intermediaries in the financing of terrorism.
                </div>
                <div>
                    7.5 Withdrawals to countries other than the Greece are limited. Users may be denied service or withdrawals without insurance (the insured amount can be up to 75% of the user's balance, depending on the country of residence and citizenship).
                </div>
                <div>
                    7.6 Withdrawals to the countries listed in paragraphs 7.4 and 7.5 are restricted. Withdrawal of funds is carried out only through the trust fund and only at the discretion of management, you can be refused without reason. All costs of establishing, maintaining and paying for the trust fund are borne by the user. The trust fund is opened only in the legal name of our platform. Once the fund is closed, the user receives a 95% refund of the originally invested funds.
                </div>
                <div>
                    8. Form of agreement. Both parties, represented by the Contractor and the Customer, accept this agreement as an agreement of equal legal force, indicated in writing.
                </div>
                <div>
                    9 Claims and disputes. Claims under this contract are accepted by the Contractor in the form of a support chat message, in which the Customer specifies the essence of the claim. This letter shall be sent to the support service
                </div>
                <div>
                    10. Carrying out exchange transactions.
                </div>
                <div>
                    10.1. It is strictly forbidden to use the services of the Contractor for illegal transfers and fraudulent activities. When concluding this agreement, the Customer undertakes to comply with these requirements and, in case of fraud, bear criminal liability established by law at the moment. 10.2. If it is impossible to fulfill the application automatically, due to circumstances beyond the control of the Contractor, such as lack of communication, lack of funds, or erroneous data of the Customer, the funds are credited to the account within the next 24 hours or returned to the details of the Customer minus commission costs.
                </div>
                <div>
                    10.3. At the first request, the Contractor has the right to transfer information about the transfer of electronic currency to law enforcement agencies, the administration of settlement systems, as well as victims of illegal actions affected by fraud proven by the judicial authorities. 10.4. The customer undertakes to provide all documents proving his identity in case of suspicion of fraud and money laundering.
                </div>
                <div>
                ...
                <div>
                    11. Disclaimer. The Contractor has the right to refuse to conclude an agreement and fulfill the application, and without explanation. This paragraph applies to any client.
                </div>
                <div>
                    12. Fees
                </div>
